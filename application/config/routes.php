...
$route['web/main'] = 'web/web';
$route['web/tentangkami'] = 'web/tk';
$route['web/berita'] = 'web/berita';
$route['web/isiberita'] = 'web/isiberita';
$route['web/isiberita/(:any)'] = 'web/isiberita/$1';
$route['web/galeri'] = 'web/galeri';
$route['web/unitkerja'] = 'web/uk';
$route['web/unitkerja/dki'] = 'web/uk_dki';
$route['web/unitkerja/jabar'] = 'web/uk/jabar';
$route['web/unitkerja/banten'] = 'web/uk/banten';
$route['web/pengaduan'] = 'web/pengaduan';
$route['web/buletin'] = 'web/buletin';


$route['web/sekdirjen'] = 'sekdirjen/index';
