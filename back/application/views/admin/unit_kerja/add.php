    <div class="container top">
      ...
      if(isset($flash_message)){
        if($flash_message == TRUE)
        {
          echo '<div class="alert alert-success">';
            ...
            echo '<strong>Well done!</strong> berita baru berhasil di tambah.';
          echo '</div>';       
        }else{
      ...
      echo form_open_multipart('admin/unit_kerja/add', $attributes);
      ?>
        <fieldset>
          <div class="control-group">
            <label for="inputError" class="control-label">Judul Berita</label>
            <div class="controls">
              <?php echo $this->ckeditor->editor('judul',@$default_value);?>
    ...
    <?php echo $this->ckeditor->editor('alamat',@$default_value);?>
<br />
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
    ...
    <?php echo $this->ckeditor->editor('isi_berita',@$default_value);?>
<br />
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
