...
class unit_kerja_model extends CI_Model {
    ...
    * @return array
    */
    public function get_unit_kerja($search_string=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
    {
    ...
    * @return int
    */
    function count_unit_kerja($search_string=null, $order=null)
    {
		$this->db->select('*');
		$this->db->from('unit_kerja');
		if($search_string){
    ...
    * @return boolean 
    */
    function store_unit_kerja($data)
    {
		$insert = $this->db->insert('unit_kerja', $data);
	    return $insert;
	}
...
function update_gambar($idf, $data)
    ...
    function update_unit_kerja($id, $data)
    {
		$this->db->where('id', $id);
